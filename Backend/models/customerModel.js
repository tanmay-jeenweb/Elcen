    ...
    try {
        ...
        const insertCustomerQuery = `
            INSERT INTO customer_master
                (customer_code, customer_name, contact_phone, contact_email, industry, currency, customer_status, time_zone, contact_name, gst_no, bank_name, bank_account_number, bank_ifsc, cheque_printing_name, pan_no, added_by, device_id)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
