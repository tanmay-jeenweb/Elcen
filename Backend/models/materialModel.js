...
const createMaterialsTable = async () => {
    // Drop existing table to ensure schema is fresh
...
const createMaterial = async (data, addedBy, deviceId) => {
    ...
    const query = `
        INSERT INTO materials
            (material_code, material_name, unit_id, hsn_code, material_group_id, material_type, gst_percent, self_val, purchase_val, unit_weight, details, remarks, added_by, device_id)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `;
