    ...
    try {
        ...
        const insertVendorQuery = `
            INSERT INTO vendor_master
                (vendor_code, vendor_name, contact_phone, contact_email, industry, currency, vendor_status, time_zone, contact_name, gst_no, bank_name, bank_account_number, bank_ifsc, cheque_printing_name, pan_no, added_by, device_id)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
