...
const workerEmployeeTypeRoutes = require("./routes/workerEmployeeTypeRoutes.js");
const workerEmployeeRoutes = require("./routes/workerEmployeeRoutes.js");
...
const { createWorkerEmployeeTypesTable } = require("./models/workerEmployeeTypeModel.js");
const { createWorkerEmployeesTable, ensureWorkerEmployeeColumns } = require("./models/workerEmployeeModel.js");
...
app.use(["/api/worker-employee-types", "/worker-employee-types"], workerEmployeeTypeRoutes);
app.use(["/api/worker-employees", "/worker-employees"], workerEmployeeRoutes);
...
const startServer = async () => {
    try {
        ...
        await createWorkerEmployeeTypesTable();
        await createWorkerEmployeesTable();
        await ensureWorkerEmployeeColumns();
