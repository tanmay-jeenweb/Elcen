                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-xl text-black text-sm outline-none transition-all duration-200 border border-slate-300 bg-white focus:border-[#043464] focus:ring-1 focus:ring-[#043464]"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full px-4 py-3 pr-12 rounded-xl text-black text-sm outline-none transition-all duration-200 border border-slate-300 bg-white focus:border-[#043464] focus:ring-1 focus:ring-[#043464]"
                                    />
                                    <button
                                        type="button"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-3.5 mt-4 rounded-xl text-white text-base font-semibold tracking-wider transition-all duration-300 bg-[#043464] hover:bg-[#03274b] shadow-md hover:shadow-lg hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-[#043464] focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed flex justify-center items-center gap-2"
                            >
                                {loading ? (
                                    <>
