        ...
        <div className="flex-1 flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border border-slate-100 text-center">
                ...
                <div className="mt-8">
                    <Link
                        to="/"
                        className="inline-flex justify-center items-center py-2.5 px-6 border border-slate-300 text-sm font-medium rounded-lg text-slate-700 bg-white hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#043464] transition-colors shadow-sm"
                    >
                        Back to Login
                    </Link>
                </div>
