...
export default function EditVendor() {
    ...
    const [formData, setFormData] = useState({
        ...
        industry: "", currency: "INR", vendor_status: "Not Approved",
        time_zone: "Asia/Kolkata", contact_name: "",
        bank_name: "", bank_account_number: "", bank_ifsc: "",
        cheque_printing_name: "", pan_no: "", gst_no: "",
    });
            ...
            try {
                ...
                if (v) {
                    setFormData({
                        ...
                        vendor_status:        v.vendor_status        || "Not Approved",
        ...
        return (
            <div className="flex-1 flex flex-col bg-slate-50">
                ...
                <div className="flex-1 flex items-center justify-center">
                    <div className="text-slate-500 text-sm">Loading vendor data...</div>
                </div>
            </div>
        );
    }
            ...
            <main className="flex-1 flex flex-col w-full mx-auto py-8 px-4 sm:px-6 lg:px-8 overflow-y-auto">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">{formData.vendor_name} ({formData.vendor_code})</p>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <button onClick={handleSubmit} disabled={loading}
                            className="px-6 py-2 text-sm font-medium text-white bg-[#043464] hover:bg-[#03274b] rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-1.5">
                                ...
                                <input type="text" name="vendor_name" value={formData.vendor_name} onChange={handleChange} className={inputCls} placeholder="e.g. Acme Corp" />
                            </div>
                            <div className="space-y-1.5">
                                <label className={labelCls}>Vendor Code <span className="text-rose-500">*</span></label>
                                <input type="text" name="vendor_code" value={formData.vendor_code} onChange={handleChange} className={inputCls} placeholder="e.g. V-001" />
                            </div>
                            <div className="space-y-1.5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input type="email" name="contact_email" value={formData.contact_email} onChange={handleChange} className={inputCls} placeholder="e.g. vendor@example.com" />
                            </div>
                            <div className="space-y-1.5">
