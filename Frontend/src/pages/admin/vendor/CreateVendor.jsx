...
export default function CreateVendor() {
    ...
    const [formData, setFormData] = useState({
        ...
        // Contact Person (kept for backend compatibility)
        contact_name:   "",
        // Bank Details
        bank_name:             "",
        bank_account_number:   "",
    ...
    const handleAddContact = () => {
        if (!currentContact.contact_name.trim()) {
    ...
    const handleAddAddress = () => {
        if (!currentAddress.address.trim() && !currentAddress.city.trim()) {
            toast.error("Please enter at least an address or city");
            return;
        }
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!formData.vendor_code || !formData.vendor_name) {
            toast.error("Vendor Code and Vendor Name are required");
            return;
        }
        setLoading(true);
        try {
            await createVendor({ ...formData, documents, contacts, addresses });
    ...
    const inputCls = "w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#043464] text-sm bg-white";
        ...
        <div className="flex-1 flex flex-col bg-slate-50 font-sans text-slate-900 h-screen overflow-hidden">
            ...
            <main className="flex-1 flex flex-col w-full mx-auto py-8 px-4 sm:px-6 lg:px-8 overflow-y-auto">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-900">Create Vendor Master</h1>
                        <p className="text-slate-500 mt-1">Add a new vendor configuration</p>
                    </div>
                    <button
                ...
                <div className="space-y-6 pb-20">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {/* Code */}
                            <div className="space-y-1.5">
                                <label className={labelCls}>Vendor Code <span className="text-rose-500">*</span></label>
                                <input
                                    type="text"
                                    name="vendor_code"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select name="vendor_status" value={formData.vendor_status} onChange={handleChange} className={inputCls}>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    type="text"
                                    name="cheque_printing_name"
                                    value={formData.cheque_printing_name}
                                    onChange={handleChange}
                                    className={inputCls}
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div className="md:col-span-3 space-y-1.5">
                                    <label className="md:col-span-4 block text-xs font-semibold text-slate-600">Address</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setCurrentAddress({ ...currentAddress, zip_code: e.target.value })}
                                        className={inputCls}
                                ...
                                <div className="flex items-end ">
                                    <button
                                        ...
                                        className="h-10 w-full px-4 bg-slate-800 hover:bg-slate-900 text-white text-sm font-medium rounded-lg transition-colors"
                                    >
                                        Add
                                    </button>
                                </div>
                                    ...
                                    <table className="min-w-full divide-y divide-slate-200">
                                        <thead className="bg-slate-50">
                                            <tr>
                                                ...
                                                <th className="px-4 py-3 text-left text-xs font-medium text-slate-500 uppercase">Zip</th>
                            ...
                            <div className="flex flex-col md:flex-row gap-4 items-end">
                                ...
                                <div className="flex-1 space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setCurrentContact({ ...currentContact, contact_number: e.target.value })}
                                        className={inputCls}
                                ...
                                <button
                                    ...
                                    className="h-10 px-4 bg-slate-800 hover:bg-slate-900 text-white text-sm font-medium rounded-lg transition-colors shrink-0"
                                >
                                    Add
                                </button>
                            </div>
                    ...
                    <div className="pt-6 flex justify-end gap-3 border-t border-slate-200">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="bg-[#043464] text-white px-8 py-2.5 rounded-lg font-medium hover:bg-[#03274b] transition-colors duration-200 disabled:cursor-not-allowed disabled:bg-slate-400 shadow-sm"
                        >
