            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "1.5px solid #043464", color: isAllAll() ? "#fff" : "#043464",
                  background: isAllAll() ? "#043464" : "#e6ebf0", transition: "all 0.2s"
                }}
              >
                      ...
                      >
                        <td style={{ padding: "12px 14px", fontSize: 14, fontWeight: 600, color: "#334155", borderBottom: "1px solid #f1f5f9" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                            <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#043464", flexShrink: 0 }} />
                            {master.label}
                          </div>
                        </td>
                        {PERMS.map((perm) => {
                        ...
                        <td style={{ textAlign: "center", padding: "12px 8px", borderBottom: "1px solid #f1f5f9" }}>
                          <button
                            ...
                            style={{
                              ...
                              border: `1.5px solid ${rowAll ? "#043464" : "#cbd5e1"}`,
                              color: rowAll ? "#fff" : "#64748b",
                              background: rowAll ? "#043464" : "#f8fafc",
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 12 }}>
            ...
            <button
              ...
              style={{
                ...
                background: saving ? "#94a3b8" : "linear-gradient(135deg,#043464,#03274b)",
                color: "#fff", fontWeight: 700, fontSize: 14, cursor: saving ? "not-allowed" : "pointer",
                boxShadow: saving ? "none" : "0 2px 8px rgba(4,52,100,0.35)",
                transition: "all 0.2s"
              }}
            >
