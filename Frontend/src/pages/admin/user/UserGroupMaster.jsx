...
const PERM_COLORS = {
  canRead:   { bg: "#f0f4f8", border: "#bcccdc", text: "#043464", check: "#043464" },
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Modal Header */}
        <div style={{ padding: "20px 28px", borderBottom: "1px solid #f1f5f9", display: "flex", alignItems: "center", justifyContent: "space-between", background: "linear-gradient(135deg,#043464,#03274b)" }}>
          <div>
        ...
        <div style={{ overflowY: "auto", flex: 1, padding: "24px 28px" }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <input
              ...
              onFocus={e => e.target.style.borderColor = "#043464"}
          ...
          <div style={{ background: "#f8fafc", borderRadius: 12, padding: 20, border: "1px solid #e2e8f0" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
              ...
              <button
                type="button"
                onClick={toggleAll}
                style={{ fontSize: 11, fontWeight: 700, padding: "5px 12px", borderRadius: 7, cursor: "pointer", border: `1.5px solid #043464`, color: isAllAll() ? "#fff" : "#043464", background: isAllAll() ? "#043464" : "#e6ebf0", transition: "all 0.2s" }}
              >
                      ...
                      <tr key={master.key} style={{ background: idx % 2 === 0 ? "#fff" : "#f8fafc" }}
                        ...
                        <td style={{ padding: "11px 12px", fontSize: 13, fontWeight: 600, color: "#334155", borderBottom: "1px solid #f1f5f9" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                            <div style={{ width: 7, height: 7, borderRadius: "50%", background: "#043464" }} />
                            {master.label}
                          </div>
                        </td>
                        {PERMS.map((perm) => (
                        ...
                        <td style={{ textAlign: "center", padding: "11px 8px", borderBottom: "1px solid #f1f5f9" }}>
                          <button type="button" onClick={() => toggleRow(master.key)}
                            style={{ fontSize: 10, fontWeight: 700, padding: "3px 9px", borderRadius: 5, cursor: "pointer", border: `1.5px solid ${rowAll ? "#043464" : "#cbd5e1"}`, color: rowAll ? "#fff" : "#64748b", background: rowAll ? "#043464" : "#f8fafc", transition: "all 0.15s" }}>
                            {rowAll ? "✓" : "All"}
                          </button>
                        </td>
                      </tr>
        ...
        <div style={{ padding: "16px 28px", borderTop: "1px solid #f1f5f9", display: "flex", justifyContent: "flex-end", gap: 12, background: "#fafafa" }}>
          ...
          <button
            ...
            style={{ padding: "9px 24px", borderRadius: 8, border: "none", background: saving ? "#94a3b8" : "linear-gradient(135deg,#043464,#03274b)", color: "#fff", fontWeight: 700, fontSize: 13, cursor: saving ? "not-allowed" : "pointer", boxShadow: saving ? "none" : "0 2px 8px rgba(4,52,100,0.35)" }}>
  ...
  const columns = useMemo(() => {
    const cols = [
      { key: "id", label: "ID", minWidth: "60px" },
      {
        ...
        render: (row) => <span style={{ fontWeight: 700, color: "#043464" }}>{row.type_name}</span>
      },
      {
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            {canUpdate && (
              <button
                ...
                style={{ display: "flex", width: 32, height: 32, alignItems: "center", justifyContent: "center", borderRadius: 8, border: "1px solid #bcccdc", background: "#f0f4f8", color: "#043464", cursor: "pointer" }}
                title="Edit"
              >
          ...
          actionButton={
            hasPermission("user_type", "write") ? (
              <button
                ...
                style={{ display: "flex", width: 40, height: 40, alignItems: "center", justifyContent: "center", borderRadius: 9, background: "linear-gradient(135deg,#043464,#03274b)", color: "#fff", border: "none", cursor: "pointer", boxShadow: "0 2px 8px rgba(4,52,100,0.35)" }}
