                    ...
                    <form onSubmit={handleCreateUser} className="space-y-6">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <input
                                ...
                                className="h-4 w-4 text-[#043464] border-slate-300 rounded focus:ring-[#043464]"
                            />
                        ...
                        <div className="pt-4">
                            <button
                                ...
                                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-[#043464] hover:bg-[#03274b] focus:ring-2 focus:ring-offset-2 focus:ring-[#043464] disabled:opacity-50 transition-colors"
                            >
