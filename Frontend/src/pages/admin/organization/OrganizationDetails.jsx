...
export default function OrganizationDetails() {
  ...
  const canWrite = hasPermission("organization_details", "write");
  ...
  const inputCls =
    "w-full border border-slate-300 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#043464] focus:border-[#043464] transition-colors text-slate-800 bg-white text-sm disabled:bg-slate-50 disabled:text-slate-500 disabled:cursor-not-allowed";
              ...
              <div className="flex flex-col items-center">
                ...
                <div
                  ...
                  className={`w-full aspect-square max-w-[240px] border-2 border-dashed rounded-xl flex flex-col items-center justify-center p-4 text-center transition-all ${
                    dragOver
                      ? "border-[#043464] bg-indigo-50/50 scale-[1.02]"
                      : logo
                    ...
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      {canWrite && (
                        <>
                          ...
                          <label className="text-xs font-semibold text-[#043464] hover:underline cursor-pointer">
                            Browse Files
                            <input
                              type="file"
                              accept="image/*"
