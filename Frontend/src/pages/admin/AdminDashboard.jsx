            ...
            render: (row) => (
                <div className="flex justify-end">
                    <button
                        ...
                        className="inline-flex justify-center rounded-md px-4 py-2 text-sm font-semibold text-white bg-[#043464] hover:bg-[#03274b] shadow-sm"
                    >
                        Approve
                    </button>
                </div>
                    ...
                    <div className="flex-1 flex flex-col mb-8">
                        {/* <div className="mb-4 p-4 border border-slate-200 bg-white shadow-sm rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            ...
                            <select
                                ...
                                className="block w-full sm:w-64 pl-3 pr-10 py-2 text-base border border-slate-300 focus:outline-none focus:ring-[#043464] focus:border-[#043464] sm:text-sm rounded-lg"
                            >
