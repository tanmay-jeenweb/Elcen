        ...
        <DataTable
          ...
          actionButton={hasPermission("location_type", "write") ? (
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#043464] text-white hover:bg-[#03274b] transition-colors shadow-sm hover:shadow"
              ...
              <form className="space-y-4" onSubmit={handleAddType}>
                ...
                <div className="flex justify-end gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="rounded-xl bg-[#043464] px-4 py-2 text-sm font-semibold text-white hover:bg-[#03274b] disabled:opacity-60"
                  >
