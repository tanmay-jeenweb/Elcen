            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#043464] focus:border-[#043464] transition-colors"
                />
              </div>

              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Location Type <span className="text-rose-500">*</span></label>
                <select
                  value={newLocation.plantTypeId}
                  onChange={(e) => setNewLocation({ ...newLocation, plantTypeId: e.target.value })}
                  className="w-full border border-slate-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#043464] focus:border-[#043464] bg-white transition-colors"
                >
